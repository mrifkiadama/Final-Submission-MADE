package com.example.adamalbarisyi.mycataloguemovieuiux.FragmentNavigation.NowPlayingPage;
...
public class NowPlayingFragment extends Fragment {
    ...
    private static final String API_URL = BuildConfig.MovieUrl + "now_playing?api_key=" + BuildConfig.ApiKey + "&language=en-US";
