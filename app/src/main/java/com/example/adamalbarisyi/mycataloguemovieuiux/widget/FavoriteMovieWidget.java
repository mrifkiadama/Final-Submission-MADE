...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.example.adamalbarisyi.mycataloguemovieuiux.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.adamalbarisyi.mycataloguemovieuiux.EXTRA_ITEM";
